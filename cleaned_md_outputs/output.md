...
11 for 2 × 2 × 2,20 for 3 × 3 × 3, Θ\left(n^{2} / \lg n\right) for n × n × n [Demaine, Demaine, Eisenstat Lubiw Winslow 2011]
...
- for each vertex u ∈ V, A d j[u] stores u 's neighbors, i.e., \{v ∈ V \mid(u, v) ∈ E\} .  (u, v) are just outgoing edges if directed. (See Fig. 2 for an example.)
...
- ⟹ \operatorname{Adj}[v] looped through only once




\text { time }=\sum_{v ∈ V}|A d j[V]|=\left\{\begin{array}{l}
